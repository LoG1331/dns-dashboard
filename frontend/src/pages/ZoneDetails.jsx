...
import { ArrowLeft, Plus, Trash2, Globe, AlertCircle, Loader2, Copy, ShieldCheck, AlertTriangle, MoreHorizontal, X, RotateCw, Download, ShieldOff, Mail } from 'lucide-react';
...
const ZoneDetails = () => {
    ...
    // Nameservers from backend config (Settings page)
                    ...
                    <div className="flex-1 min-w-0">
                        <h1 className="text-lg md:text-2xl font-bold text-white flex items-center gap-2 md:gap-3">
                            ...
                            <span className={`text-[9px] md:text-[11px] px-2 md:px-2.5 py-0.5 md:py-1 rounded-md uppercase tracking-wider font-bold shadow-sm whitespace-nowrap ${zone.status === 'active'
                                ...
                                {zone.status === 'pending_verification' ? 'Pending' : zone.status === 'suspended' ? 'Suspended' : zone.status}
                            </span>
                        </h1>
                    </div>
                </div>
                            ...
                            <div className="space-y-4 w-full">
                                <div>
                                    ...
                                    <p className="text-gray-300 text-sm max-w-2xl leading-relaxed">
                                        ...
                                        Replace your current nameservers with the nameservers below.
                                    </p>
                                </div>
                            ...
                            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400 text-xs mt-1">
                                            If you believe your domain was suspended in error, please contact your administrator with your domain name and account details.
                                        </p>
                                    </div>
                                </div>
                            </div>
