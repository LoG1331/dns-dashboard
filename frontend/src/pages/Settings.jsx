        ...
        <div className="space-y-8 max-w-7xl mx-auto">
            ...
            <div className="bg-[#262626]/40 backdrop-blur-md border border-white/5 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                    ...
                    <form onSubmit={handleUpdatePassword} className="space-y-4 lg:border-l lg:border-white/5 lg:pl-12">
                        <h3 className="text-sm font-bold text-gray-300 flex items-center gap-2">
                            <Shield className="w-4 h-4 text-[#38BDF8]" /> Change Password
                        </h3>
