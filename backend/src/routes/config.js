...
router.put("/", (req, res) => {
  const { pdnsApiUrl, pdnsApiKey, pdnsServerId, zoneKind, ns1, ns2, masterAddress, secondaries } = req.body || {};
  ...
  const cfg = updateConfig({ pdnsApiUrl, pdnsApiKey, pdnsServerId, zoneKind, ns1, ns2, masterAddress, secondaries });
